...
import { getTattooById } from "../../../../../database/dbTattoos";

// TODO: in the future, this should probably be static
...
const TattooDetailsPage = async ({ params }) => {
    ...
    const tattoo = await getTattooById(params.id);

    return (
        <div className="container  mx-auto flex-1 flex items-start justify-center flex-wrap px-2 gap-2" >
            <Image src={tattoo.images[0]} alt={"this is a test"} width={500} height={500} />
